...
class PromotedData extends AbstractFixture implements OrderedFixtureInterface
{

    public function load(ObjectManager $manager)
    {
        $promoted_1 = new Promoted();
...
//        $Article_1->setPromoted($this->getReference('Promoted'));
        ...
        $this->addReference('promoted_1', $promoted_1);
        $this->addReference('promoted_2', $promoted_2);
        $this->addReference('promoted_3', $promoted_3);
    }
